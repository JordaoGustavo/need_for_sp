...
export const CARS: readonly CarDefinition[] = [
  ...
  // brakingKmhPerSec ≈ 50 stops 100→0 in ~2s — hard but with real weight to it.
  {
    ...
    visual: { color: "#ff5a1f", displayName: "Civic Turbo", bodyStyle: "coupe", model: { url: "/models/sports-hatchback.glb", bodyMaterials: ["Mat_M3Body"] } },
  ...
  },
  {
    ...
    visual: { color: "#1fa2ff", displayName: "Golf GTI", bodyStyle: "hatch", accentColor: "#e11d2e", model: { url: "/models/kay-hatchback.glb" } },
  ...
  },
  {
    ...
    visual: { color: "#f2d200", displayName: "Supra Drift", bodyStyle: "supra", model: { url: "/models/rx7.glb", bodyMaterials: ["Body_paint"], hideNodes: ["Logos"] } },
  ...
  // --- Garagem JDM do ETNRLZ ("a garagem JDM mais valiosa do Brasil") -------
  {
    ...
    visual: { color: "#f2c200", displayName: "Novo Z", bodyStyle: "coupe", model: { url: "/models/180sx.glb", bodyMaterials: ["Body", "Body.001"] } },
  ...
  },
  {
    ...
    visual: { color: "#2456c4", displayName: "Skyline R34", bodyStyle: "supra", model: { url: "/models/r34.glb", bodyMaterials: ["chasis", "chasis_NONE"] } },
  ...
  // --- Garagem do Ricardinho ACF (ACF Performance) --------------------------
  {
    ...
    visual: { color: "#c9ced4", displayName: "Chevette ACF", bodyStyle: "coupe", model: { url: "/models/ae86.glb" } },
  ...
  // --- Garagem do Alemão da Caravan ------------------------------------------
  {
    ...
    visual: { color: "#d6c096", displayName: "Caravan Turbo", bodyStyle: "wagon", model: { url: "/models/stationwagon.glb" } },
  ...
  },
  {
    ...
    visual: { color: "#4a4f57", displayName: "Comodoro Turbo", bodyStyle: "supra", model: { url: "/models/charger.glb", bodyMaterials: ["Red_Chasis"] } },
  ...
  },
  {
    ...
    visual: { color: "#f2b23d", displayName: "Chevette Supere", bodyStyle: "coupe", model: { url: "/models/defiance.glb", bodyMaterials: ["Body"] } },
